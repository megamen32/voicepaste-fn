...
**VoicePaste Fn** is a lightweight macOS menu bar application that transcribes voice input to text in real-time using OpenAI's Whisper API. Hold the `Fn` key, speak, release, and your words appear in the clipboard—ready to paste anywhere.
